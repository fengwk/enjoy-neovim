...
local function on_attach(client, bufnr)
  ...
  -- vim.keymap.set("n", "gS", vim.lsp.buf.workspace_symbol, { noremap = true, silent = true, buffer = bufnr, desc = "Lsp Implementation" })
  ...
  vim.keymap.set("n", "ge", "<Cmd>lua require('telescope.builtin').diagnostics()<CR>", { noremap = true, silent = true, buffer = bufnr, desc = "Lsp Diagnostics" })
