...
local function on_attach(client, bufnr)
  ...
  -- vim.keymap.set("n", "gS",  "<Cmd>lua require('telescope.builtin').lsp_dynamic_workspace_symbols()<CR>", { noremap = true, silent = true, buffer = bufnr, desc = "Lsp Workspace Symbol" })
