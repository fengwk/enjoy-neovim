...
local enhancer = require("fengwk.plugins.workspaces.enhancer")
...
require("workspaces").setup({
    ...
    hooks = {
        add = {
          "lua require('fengwk.plugins.workspaces.enhancer').record_ws_buf('" ..  ws_dir .."')",
        },
        remove = {},
        rename = {},
        open_pre = {},
        open = {
          ...
          "lua require('fengwk.plugins.workspaces.enhancer').reload_ws_buf('" ..  ws_dir .."')",
        },
    },
})
